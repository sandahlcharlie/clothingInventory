...
public class ClothingStackQueueDriver {
    ...
    public static void main(String[] args) {
        ...
        Queue<Clothing> mixedQ = new LinkedList<>();
        mixedQ.offer(new Clothing("Socks", 15));
        mixedQ.offer(new Pants("Jeans", 20, 32));
        mixedQ.offer(new Shirt("Graphic Tee", 10, false));
        mixedQ.offer(new Pants("Dress Pants", 8, 34));
        mixedQ.offer(new Shirt("Dress Shirt", 12, true));
        Queue<Clothing> pantsQ = new LinkedList<>();
        pantsQ.offer(new Pants("Jeans", 15, 33));
        pantsQ.offer(new Pants("Chinos", 10, 32));
        pantsQ.offer(new Pants("Sweatpants", 12, 34));
        pantsQ.offer(new Pants("Dress Pants", 8, 31));
        Queue<Clothing> shirtQ = new LinkedList<>();
        shirtQ.offer(new Shirt("Graphic Tee", 15, false));
        shirtQ.offer(new Shirt("Dress Shirt", 10, true));
        shirtQ.offer(new Shirt("Polo", 8, false));
        shirtQ.offer(new Shirt("Hoodie", 5, true));
        System.out.println("Input queue has a mix of Item, ItemA and ItemB items.");
        System.out.println("input:");
        System.out.println(mixedQ);
        System.out.println("output split(mixedQ):");
        Queue<Clothing>[] split = split(mixedQ);
        ...
        System.out.println("input:");
        System.out.println(pantsQ);
        System.out.println("output split(pantsQ):");
        Queue<Clothing>[] splitPants = split(pantsQ);
        System.out.println("index 0:");
        System.out.println(splitPants[0]);
        System.out.println("index 1:");
        System.out.println(splitPants[0]);
        System.out.println();
        System.out.println(pantsQ);
        ...
        System.out.println("output split(pantsQ):");
        Queue<Clothing>[] splitShirt = split(pantsQ);
        System.out.println("index 0:");
        System.out.println(splitShirt[0]);
        System.out.println("index 1:");
        System.out.println(splitShirt[0]);
        System.out.println();
        System.out.println(pantsQ);
        ...
        System.out.println("input:");
        System.out.println(fourQSwap);
        Queue<Clothing>[] splitClothing = split(fourQSwap);
        System.out.println("output split(fourQSwap):");
        System.out.println("index 0:");
        System.out.println(splitClothing[0]);
        System.out.println("index 1:");
        System.out.println(splitClothing[1]);
        System.out.println(fourQSwap);
        System.out.println();
        ...
        System.out.println(emptyQ);
        System.out.println("output:");
        Queue<Clothing>[] splitEmpty = split(fourQSwap);
        System.out.println("index 0:");
        System.out.println(splitEmpty[1]);
        System.out.println("index 1:");
        System.out.println(splitEmpty[0]);
        System.out.println(emptyQ);
        System.out.println("--------------------------------------------------------");
